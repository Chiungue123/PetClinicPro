...
export class PetService {
  ...
  getPets(): Observable<Pet[]> {
    ...
    //return this.http.get<Pet[]>("http://spring-container:9050/pets");
  }

  getPet(id: Number): Observable<Pet> {
    //console.log("From Pet Service: Getting Pet: " + id);
    //return this.http.get<Pet>("http://spring-container:9050/pets/" + id);
    return this.http.get<Pet>("http://localhost:9050/pets/" + id);
  }

  addPet(pet: Pet) {
    //console.log("Add Pet: ", pet);
    //return this.http.post("http://spring-container:9050/pets", pet);
    return this.http.post("http://localhost:9050/pets", pet);
  }

  updatePet(pet: Pet) {
    //console.log("Update Pet: ", pet);
    //return this.http.put("http://spring-container:9050/pets/update/" + pet.petID, pet);
    return this.http.put("http://localhost:9050/pets/update/" + pet.petID, pet);
  }

  deletePet(id: Number) {
    //console.log("Delete Pet: " + id);
    //return this.http.delete("http://spring-container:9050/pets/" + id);
